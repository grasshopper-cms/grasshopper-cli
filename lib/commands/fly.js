...
function startApp(){
    ...
    logger.trace('');
    logger.trace('RUNNING: ' + cmd);
    logger.trace('Browse to your site at: http://localhost:3000');
    logger.trace('Get to the admin at: http://localhost:3000/admin\n' +
                 'Credentials are: admin / TestPassword (remember to change)');
